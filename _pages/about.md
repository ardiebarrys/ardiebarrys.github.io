...
.profile-logo-links a:nth-child(1) { animation-delay: 180ms; }
.profile-logo-links a:nth-child(2) { animation-delay: 240ms; }
.profile-logo-links a:nth-child(3) { animation-delay: 300ms; }
.profile-logo-links a:nth-child(4) { animation-delay: 360ms; }
.profile-logo-links a:nth-child(5) { animation-delay: 420ms; }
.profile-logo-links a:nth-child(6) { animation-delay: 480ms; }
.profile-logo-links a:nth-child(7) { animation-delay: 540ms; }
  ...
  .keyword-list span:hover {
    ...
    box-shadow: 0 5px 14px rgba(183, 0, 183, 0.14);
  }
